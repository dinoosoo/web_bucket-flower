...
<head>
    ...
    <title>Pembelian Bucket Flower | Buat Pembelian Bucket Flower Baru</title>
</head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">Buat Pembelian Bucket Flower Baru</div>
                    <div class="card-body">
                        <form action="{{ route('pembelians.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="nama_produk">Nama Bunga:</label>
