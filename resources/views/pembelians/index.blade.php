...
<head>
    ...
    <title>Pembelian Bucket Flower</title>
</head>
...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h1 class="text-center my-4" style="font-weight: bolder">Pembelian Bucket Flower<a href="/"
                        style="color: #47b5ff; text-decoration: none;" title="Ke halaman Home"></a></h1>
                    <hr>
                </div>
                <div class="card">
                    <div class="card-header text-center">Data Pembelian Bucket Flower</div>
